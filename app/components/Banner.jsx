...
const Banner = () => {
  return (
    <div className="relative">
      <div className="bg-[#E2F5FB] pb-[200px] h-[900px] mb-[400px]"> {/* Added bottom padding */}
        <h1 className="font-bold text-8xl text-center py-10 text-[#003569] tracking-[16px]">
          Essential Vitamins
        </h1>
        <div className="max-w-6xl mx-auto grid grid-cols-3 items-end gap-10">
          {/* Explore section  */}
          <div className="flex flex-col justify-start pl-10">
            ...
            <button className="w-40 bg-[#17414F] h-14 text-white rounded-full font-semibold text-[16px]">
              EXPLORE
            </button>
          </div>
          {/* capsule section  */}
          <div className="bg-[#FFE9B5] rounded-tl-[130px] rounded-br-[130px] relative h-[362px]">
